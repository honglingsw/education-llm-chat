...
export default [
    {
      ...
      image: "https://up2.aigcpmer.com/TEACHER_QUALIFICATION_EXAM.png",
    ...
    },
    {
      ...
      image: "https://up2.aigcpmer.com/TEACHER_RECRUITMENT_EXAM.png",
      icon: "el-icon-user-solid",
      isForWaiting: false
    },
    {
      ...
      type: "structured",
      code: "GOV_EXAM",
      image: "https://up2.aigcpmer.com/GOV_EXAM.png",
      icon: "el-icon-user",
      isForWaiting: false
    },
    {
      ...
      type: "structured",
      code: "GOV_INTERVIEW",
      image: "https://up2.aigcpmer.com/GOV_INTERVIEW.png",
      icon: "el-icon-user-solid",
      isForWaiting: true
    },
    {
      ...
      image: "https://up2.aigcpmer.com/AI_PRODUCT_MANAGER.png",
      icon: "el-icon-user-solid",
      isForWaiting: true
    },
    {
      ...
      icon: "el-icon-user-solid",
      image: "https://up2.aigcpmer.com/PRODUCT_OPERATION.png",
      isForWaiting: true
    },
    {
      id: 8,
      ...
      image: "https://up2.aigcpmer.com/FRONTEND_DEVELOPMENT.png",
      icon: "el-icon-user-solid",
      isForWaiting: true
    },
    {
      ...
      image: "https://up2.aigcpmer.com/BACKEND_DEVELOPMENT.png",
      icon: "el-icon-user-solid",
      isForWaiting: true
    },
    {
      ...
      type: "structured",
      code: "DATA_SCIENCE",
      image: "https://up2.aigcpmer.com/DATA_SCIENCE.png",
      icon: "el-icon-user-solid",
      isForWaiting: true
    }
  ];
